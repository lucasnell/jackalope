...
//     Q = {{'A', std::vector<double>(n_events, 0.0)},
//          {'C', std::vector<double>(n_events, 0.0)},
//          {'G', std::vector<double>(n_events, 0.0)},
//          {'T', std::vector<double>(n_events, 0.0)}};
...
//             Q[c][i + 4] = omega(i) * xi_i;
//             Q[c][i + 4 + 10] = omega(i) * xi_d;
//         }
//     }
//
//     // -----------
...
//         double qi = -(Q[c][ind]);
//         for (uint i = 0; i < n_events; i++) qm->M[c][i] = Q[c][i] / qi;
//         qm->M[c][ind] = 0;
