...
#' @noRd
#'
illumina_var_cpp <- function(var_set_ptr, paired, out_prefix, compress, n_reads, prob_dup, n_cores, read_chunk_size, variant_probs, frag_len_shape, frag_len_scale, frag_len_min, frag_len_max, qual_probs1, quals1, ins_prob1, del_prob1, qual_probs2, quals2, ins_prob2, del_prob2, barcodes, instrument, run_number, flowcell_ID, lane, tile, x_pos, y_pos, read, is_filtered, control_number, sample_number) {
    invisible(.Call(`_gemino_illumina_var_cpp`, var_set_ptr, paired, out_prefix, compress, n_reads, prob_dup, n_cores, read_chunk_size, variant_probs, frag_len_shape, frag_len_scale, frag_len_min, frag_len_max, qual_probs1, quals1, ins_prob1, del_prob1, qual_probs2, quals2, ins_prob2, del_prob2, barcodes, instrument, run_number, flowcell_ID, lane, tile, x_pos, y_pos, read, is_filtered, control_number, sample_number))
}
...
#' @noRd
#'
pacbio_ref_cpp <- function(ref_genome_ptr, out_prefix, compress, n_reads, n_cores, read_chunk_size, prob_dup, scale, sigma, loc, min_frag_len, read_probs, read_lens, max_passes, chi2_params_n, chi2_params_s, sqrt_params, norm_params, prob_thresh, prob_ins, prob_del, prob_subst, instrument, run_number, flowcell_ID, lane, tile, x_pos, y_pos, read, is_filtered, control_number, sample_number) {
    invisible(.Call(`_gemino_pacbio_ref_cpp`, ref_genome_ptr, out_prefix, compress, n_reads, n_cores, read_chunk_size, prob_dup, scale, sigma, loc, min_frag_len, read_probs, read_lens, max_passes, chi2_params_n, chi2_params_s, sqrt_params, norm_params, prob_thresh, prob_ins, prob_del, prob_subst, instrument, run_number, flowcell_ID, lane, tile, x_pos, y_pos, read, is_filtered, control_number, sample_number))
}
...
pacbio_var_cpp <- function(var_set_ptr, out_prefix, compress, n_reads, n_cores, read_chunk_size, variant_probs, prob_dup, scale, sigma, loc, min_frag_len, read_probs, read_lens, max_passes, chi2_params_n, chi2_params_s, sqrt_params, norm_params, prob_thresh, prob_ins, prob_del, prob_subst, instrument, run_number, flowcell_ID, lane, tile, x_pos, y_pos, read, is_filtered, control_number, sample_number) {
    invisible(.Call(`_gemino_pacbio_var_cpp`, var_set_ptr, out_prefix, compress, n_reads, n_cores, read_chunk_size, variant_probs, prob_dup, scale, sigma, loc, min_frag_len, read_probs, read_lens, max_passes, chi2_params_n, chi2_params_s, sqrt_params, norm_params, prob_thresh, prob_ins, prob_del, prob_subst, instrument, run_number, flowcell_ID, lane, tile, x_pos, y_pos, read, is_filtered, control_number, sample_number))
}
