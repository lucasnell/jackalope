...
make_mutation_sampler_base <- function(Q, pi_tcag, insertion_rates, deletion_rates, rej_sample, gamma_size) {
    .Call(`_jackalope_make_mutation_sampler_base`, Q, pi_tcag, insertion_rates, deletion_rates, rej_sample, gamma_size)
}
